...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """was published recently () returns True for 
...
class QuestionIndexViewTests(TestCase):
    def test_noquestions(self):
        """If no question existm an appropiate message is displayed.
        """
        response= self.client.get(reverse('polls:inex'))
    ...
    def test_future_question(self):
        ...
        response=self.client.get(reverse('polls:index'))
        self.assertContains(response, "No polls are available.")
        self.assertQuerysetEqual(response.context['latest_quetion_list'],[])
    ...
    def test_two_past_questions(self):
        """The questions index page may dispay multiple questions."""
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        """The detail view of a quesstion with a pub_date
        in the past dips´ñays the qestion's text."""
